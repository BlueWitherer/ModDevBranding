...
### Submit Branding
If you're a mod developer, visit **[moddev.cubicstudios.xyz](https://moddev.cubicstudios.xyz/)** to access the dashboard to submit your branding! It will automatically appear on all of your mods. You will be required to authorize with your [GitHub account](https://www.github.com/login/) to use the website.
